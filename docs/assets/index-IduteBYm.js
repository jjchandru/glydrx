...
`)+`
`+f);const E=b+m+a,S=b+f+o,I=Sc(i,i.VERTEX_SHADER,E),C=Sc(i,i.FRAGMENT_SHADER,S);i.attachShader(x,I),i.attachShader(x,C),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function A(P){if(s.debug.checkShaderErrors){const W=i.getProgramInfoLog(x).trim(),H=i.getShaderInfoLog(I).trim(),K=i.getShaderInfoLog(C).trim();let j=!0,G=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(j=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,x,I,C);else{const z=Ec(i,I,"vertex"),k=Ec(i,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
...
}`;function Eg(s,e,t){let n=new Ja;const i=new ke,r=new ke,a=new je,o=new vh({depthPacking:ou}),c=new Mh,l={},u=t.maxTextureSize,h={[Tn]:It,[It]:Tn,[sn]:sn},d=new Bn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ke},radius:{value:4}},vertexShader:Sg,fragmentShader:yg}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new cn;g.setAttribute("position",new Ct(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new ct(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Oc;let f=this.type;this.render=function(C,A,N){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const y=s.getRenderTarget(),M=s.getActiveCubeFace(),P=s.getActiveMipmapLevel(),W=s.state;W.setBlending(Fn),W.buffers.color.setClear(1,1,1,1),W.buffers.depth.setTest(!0),W.setScissorTest(!1);const H=f!==_n&&this.type===_n,K=f===_n&&this.type!==_n;for(let j=0,G=C.length;j<G;j++){const z=C[j],k=z.shadow;if(k===void 0){console.warn("THREE.WebGLShadowMap:",z,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;i.copy(k.mapSize);const ne=k.getFrameExtents();if(i.multiply(ne),r.copy(k.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(r.x=Math.floor(u/ne.x),i.x=r.x*ne.x,k.mapSize.x=r.x),i.y>u&&(r.y=Math.floor(u/ne.y),i.y=r.y*ne.y,k.mapSize.y=r.y)),k.map===null||H===!0||K===!0){const ve=this.type!==_n?{minFilter:Rt,magFilter:Rt}:{};k.map!==null&&k.map.dispose(),k.map=new ri(i.x,i.y,ve),k.map.texture.name=z.name+".shadowMap",k.camera.updateProjectionMatrix()}s.setRenderTarget(k.map),s.clear();const ce=k.getViewportCount();for(let ve=0;ve<ce;ve++){const Oe=k.getViewport(ve);a.set(r.x*Oe.x,r.y*Oe.y,r.x*Oe.z,r.y*Oe.w),W.viewport(a),k.updateMatrices(z,ve),n=k.getFrustum(),S(A,N,k.camera,z,this.type)}k.isPointLightShadow!==!0&&this.type===_n&&b(k,N),k.needsUpdate=!1}f=this.type,m.needsUpdate=!1,s.setRenderTarget(y,M,P)};function b(C,A){const N=e.update(x);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new ri(i.x,i.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,s.setRenderTarget(C.mapPass),s.clear(),s.renderBufferDirect(A,null,N,d,x,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,s.setRenderTarget(C.map),s.clear(),s.renderBufferDirect(A,null,N,p,x,null)}function E(C,A,N,y){let M=null;const P=N.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(P!==void 0)M=P;else if(M=N.isPointLight===!0?c:o,s.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const W=M.uuid,H=A.uuid;let K=l[W];K===void 0&&(K={},l[W]=K);let j=K[H];j===void 0&&(j=M.clone(),K[H]=j,A.addEventListener("dispose",I)),M=j}if(M.visible=A.visible,M.wireframe=A.wireframe,y===_n?M.side=A.shadowSide!==null?A.shadowSide:A.side:M.side=A.shadowSide!==null?A.shadowSide:h[A.side],M.alphaMap=A.alphaMap,M.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,M.map=A.map,M.clipShadows=A.clipShadows,M.clippingPlanes=A.clippingPlanes,M.clipIntersection=A.clipIntersection,M.displacementMap=A.displacementMap,M.displacementScale=A.displacementScale,M.displacementBias=A.displacementBias,M.wireframeLinewidth=A.wireframeLinewidth,M.linewidth=A.linewidth,N.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const W=s.properties.get(M);W.light=N}return M}function S(C,A,N,y,M){if(C.visible===!1)return;if(C.layers.test(A.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&M===_n)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse,C.matrixWorld);const H=e.update(C),K=C.material;if(Array.isArray(K)){const j=H.groups;for(let G=0,z=j.length;G<z;G++){const k=j[G],ne=K[k.materialIndex];if(ne&&ne.visible){const ce=E(C,ne,y,M);C.onBeforeShadow(s,C,A,N,H,ce,k),s.renderBufferDirect(N,null,H,ce,C,k),C.onAfterShadow(s,C,A,N,H,ce,k)}}}else if(K.visible){const j=E(C,K,y,M);C.onBeforeShadow(s,C,A,N,H,j,null),s.renderBufferDirect(N,null,H,j,C,null),C.onAfterShadow(s,C,A,N,H,j,null)}}const W=C.children;for(let H=0,K=W.length;H<K;H++)S(W[H],A,N,y,M)}function I(C){C.target.removeEventListener("dispose",I);for(const N in l){const y=l[N],M=C.target.uuid;M in y&&(y[M].dispose(),delete y[M])}}}const Tg={[Zr]:$r,[Jr]:ta,[Qr]:na,[wi]:ea,[$r]:Zr,[ta]:Jr,[na]:Qr,[ea]:wi};function bg(s,e){function t(){let R=!1;const ae=new je;let J=null;const de=new je(0,0,0,0);return{setMask:function(Q){J!==Q&&!R&&(s.colorMask(Q,Q,Q,Q),J=Q)},setLocked:function(Q){R=Q},setClear:function(Q,Y,fe,De,it){it===!0&&(Q*=De,Y*=De,fe*=De),ae.set(Q,Y,fe,De),de.equals(ae)===!1&&(s.clearColor(Q,Y,fe,De),de.copy(ae))},reset:function(){R=!1,J=null,de.set(-1,0,0,0)}}}function n(){let R=!1,ae=!1,J=null,de=null,Q=null;return{setReversed:function(Y){if(ae!==Y){const fe=e.get("EXT_clip_control");Y?fe.clipControlEXT(fe.LOWER_LEFT_EXT,fe.ZERO_TO_ONE_EXT):fe.clipControlEXT(fe.LOWER_LEFT_EXT,fe.NEGATIVE_ONE_TO_ONE_EXT),ae=Y;const De=Q;Q=null,this.setClear(De)}},getReversed:function(){return ae},setTest:function(Y){Y?le(s.DEPTH_TEST):Se(s.DEPTH_TEST)},setMask:function(Y){J!==Y&&!R&&(s.depthMask(Y),J=Y)},setFunc:function(Y){if(ae&&(Y=Tg[Y]),de!==Y){switch(Y){case Zr:s.depthFunc(s.NEVER);break;case $r:s.depthFunc(s.ALWAYS);break;case Jr:s.depthFunc(s.LESS);break;case wi:s.depthFunc(s.LEQUAL);break;case Qr:s.depthFunc(s.EQUAL);break;case ea:s.depthFunc(s.GEQUAL);break;case ta:s.depthFunc(s.GREATER);break;case na:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}de=Y}},setLocked:function(Y){R=Y},setClear:function(Y){Q!==Y&&(ae&&(Y=1-Y),s.clearDepth(Y),Q=Y)},reset:function(){R=!1,J=null,de=null,Q=null,ae=!1}}}function i(){let R=!1,ae=null,J=null,de=null,Q=null,Y=null,fe=null,De=null,it=null;return{setTest:function($e){R||($e?le(s.STENCIL_TEST):Se(s.STENCIL_TEST))},setMask:function($e){ae!==$e&&!R&&(s.stencilMask($e),ae=$e)},setFunc:function($e,Vt,un){(J!==$e||de!==Vt||Q!==un)&&(s.stencilFunc($e,Vt,un),J=$e,de=Vt,Q=un)},setOp:function($e,Vt,un){(Y!==$e||fe!==Vt||De!==un)&&(s.stencilOp($e,Vt,un),Y=$e,fe=Vt,De=un)},setLocked:function($e){R=$e},setClear:function($e){it!==$e&&(s.clearStencil($e),it=$e)},reset:function(){R=!1,ae=null,J=null,de=null,Q=null,Y=null,fe=null,De=null,it=null}}}const r=new t,a=new n,o=new i,c=new WeakMap,l=new WeakMap;let u={},h={},d=new WeakMap,p=[],g=null,x=!1,m=null,f=null,b=null,E=null,S=null,I=null,C=null,A=new Ce(0,0,0),N=0,y=!1,M=null,P=null,W=null,H=null,K=null;const j=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,z=0;const k=s.getParameter(s.VERSION);k.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec(k)[1]),G=z>=1):k.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec(k)[1]),G=z>=2);let ne=null,ce={};const ve=s.getParameter(s.SCISSOR_BOX),Oe=s.getParameter(s.VIEWPORT),Xe=new je().fromArray(ve),q=new je().fromArray(Oe);function te(R,ae,J,de){const Q=new Uint8Array(4),Y=s.createTexture();s.bindTexture(R,Y),s.texParameteri(R,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(R,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let fe=0;fe<J;fe++)R===s.TEXTURE_3D||R===s.TEXTURE_2D_ARRAY?s.texImage3D(ae,0,s.RGBA,1,1,de,0,s.RGBA,s.UNSIGNED_BYTE,Q):s.texImage2D(ae+fe,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Q);return Y}const Me={};Me[s.TEXTURE_2D]=te(s.TEXTURE_2D,s.TEXTURE_2D,1),Me[s.TEXTURE_CUBE_MAP]=te(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),Me[s.TEXTURE_2D_ARRAY]=te(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),Me[s.TEXTURE_3D]=te(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),le(s.DEPTH_TEST),a.setFunc(wi),Ke(!1),nt(po),le(s.CULL_FACE),w(Fn);function le(R){u[R]!==!0&&(s.enable(R),u[R]=!0)}function Se(R){u[R]!==!1&&(s.disable(R),u[R]=!1)}function qe(R,ae){return h[R]!==ae?(s.bindFramebuffer(R,ae),h[R]=ae,R===s.DRAW_FRAMEBUFFER&&(h[s.FRAMEBUFFER]=ae),R===s.FRAMEBUFFER&&(h[s.DRAW_FRAMEBUFFER]=ae),!0):!1}function we(R,ae){let J=p,de=!1;if(R){J=d.get(ae),J===void 0&&(J=[],d.set(ae,J));const Q=R.textures;if(J.length!==Q.length||J[0]!==s.COLOR_ATTACHMENT0){for(let Y=0,fe=Q.length;Y<fe;Y++)J[Y]=s.COLOR_ATTACHMENT0+Y;J.length=Q.length,de=!0}}else J[0]!==s.BACK&&(J[0]=s.BACK,de=!0);de&&s.drawBuffers(J)}function rt(R){return g!==R?(s.useProgram(R),g=R,!0):!1}const at={[ei]:s.FUNC_ADD,[Ll]:s.FUNC_SUBTRACT,[Il]:s.FUNC_REVERSE_SUBTRACT};at[Dl]=s.MIN,at[Ul]=s.MAX;const Ye={[Nl]:s.ZERO,[Fl]:s.ONE,[Ol]:s.SRC_COLOR,[Kr]:s.SRC_ALPHA,[Gl]:s.SRC_ALPHA_SATURATE,[kl]:s.DST_COLOR,[zl]:s.DST_ALPHA,[Bl]:s.ONE_MINUS_SRC_COLOR,[jr]:s.ONE_MINUS_SRC_ALPHA,[Vl]:s.ONE_MINUS_DST_COLOR,[Hl]:s.ONE_MINUS_DST_ALPHA,[Wl]:s.CONSTANT_COLOR,[Xl]:s.ONE_MINUS_CONSTANT_COLOR,[ql]:s.CONSTANT_ALPHA,[Yl]:s.ONE_MINUS_CONSTANT_ALPHA};function w(R,ae,J,de,Q,Y,fe,De,it,$e){if(R===Fn){x===!0&&(Se(s.BLEND),x=!1);return}if(x===!1&&(le(s.BLEND),x=!0),R!==Pl){if(R!==m||$e!==y){if((f!==ei||S!==ei)&&(s.blendEquation(s.FUNC_ADD),f=ei,S=ei),$e)switch(R){case Ei:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case mo:s.blendFunc(s.ONE,s.ONE);break;case go:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case _o:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}else switch(R){case Ei:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case mo:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case go:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case _o:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}b=null,E=null,I=null,C=null,A.set(0,0,0),N=0,m=R,y=$e}return}Q=Q||ae,Y=Y||J,fe=fe||de,(ae!==f||Q!==S)&&(s.blendEquationSeparate(at[ae],at[Q]),f=ae,S=Q),(J!==b||de!==E||Y!==I||fe!==C)&&(s.blendFuncSeparate(Ye[J],Ye[de],Ye[Y],Ye[fe]),b=J,E=de,I=Y,C=fe),(De.equals(A)===!1||it!==N)&&(s.blendColor(De.r,De.g,De.b,it),A.copy(De),N=it),m=R,y=!1}function Et(R,ae){R.side===sn?Se(s.CULL_FACE):le(s.CULL_FACE);let J=R.side===It;ae&&(J=!J),Ke(J),R.blending===Ei&&R.transparent===!1?w(Fn):w(R.blending,R.blendEquation,R.blendSrc,R.blendDst,R.blendEquationAlpha,R.blendSrcAlpha,R.blendDstAlpha,R.blendColor,R.blendAlpha,R.premultipliedAlpha),a.setFunc(R.depthFunc),a.setTest(R.depthTest),a.setMask(R.depthWrite),r.setMask(R.colorWrite);const de=R.stencilWrite;o.setTest(de),de&&(o.setMask(R.stencilWriteMask),o.setFunc(R.stencilFunc,R.stencilRef,R.stencilFuncMask),o.setOp(R.stencilFail,R.stencilZFail,R.stencilZPass)),Ge(R.polygonOffset,R.polygonOffsetFactor,R.polygonOffsetUnits),R.alphaToCoverage===!0?le(s.SAMPLE_ALPHA_TO_COVERAGE):Se(s.SAMPLE_ALPHA_TO_COVERAGE)}function Ke(R){M!==R&&(R?s.frontFace(s.CW):s.frontFace(s.CCW),M=R)}function nt(R){R!==wl?(le(s.CULL_FACE),R!==P&&(R===po?s.cullFace(s.BACK):R===Rl?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Se(s.CULL_FACE),P=R}function ge(R){R!==W&&(G&&s.lineWidth(R),W=R)}function Ge(R,ae,J){R?(le(s.POLYGON_OFFSET_FILL),(H!==ae||K!==J)&&(s.polygonOffset(ae,J),H=ae,K=J)):Se(s.POLYGON_OFFSET_FILL)}function Ee(R){R?le(s.SCISSOR_TEST):Se(s.SCISSOR_TEST)}function Ne(R){R===void 0&&(R=s.TEXTURE0+j-1),ne!==R&&(s.activeTexture(R),ne=R)}function ft(R,ae,J){J===void 0&&(ne===null?J=s.TEXTURE0+j-1:J=ne);let de=ce[J];de===void 0&&(de={type:void 0,texture:void 0},ce[J]=de),(de.type!==R||de.texture!==ae)&&(ne!==J&&(s.activeTexture(J),ne=J),s.bindTexture(R,ae||Me[R]),de.type=R,de.texture=ae)}function T(){const R=ce[ne];R!==void 0&&R.type!==void 0&&(s.bindTexture(R.type,null),R.type=void 0,R.texture=void 0)}function _(){try{s.compressedTexImage2D(...arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function F(){try{s.compressedTexImage3D(...arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function X(){try{s.texSubImage2D(...arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Z(){try{s.texSubImage3D(...arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function V(){try{s.compressedTexSubImage2D(...arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function _e(){try{s.compressedTexSubImage3D(...arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function re(){try{s.texStorage2D(...arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function me(){try{s.texStorage3D(...arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function xe(){try{s.texImage2D(...arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function $(){try{s.texImage3D(...arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ue(R){Xe.equals(R)===!1&&(s.scissor(R.x,R.y,R.z,R.w),Xe.copy(R))}function Ae(R){q.equals(R)===!1&&(s.viewport(R.x,R.y,R.z,R.w),q.copy(R))}function be(R,ae){let J=l.get(ae);J===void 0&&(J=new WeakMap,l.set(ae,J));let de=J.get(R);de===void 0&&(de=s.getUniformBlockIndex(ae,R.name),J.set(R,de))}function ie(R,ae){const de=l.get(ae).get(R);c.get(ae)!==de&&(s.uniformBlockBinding(ae,de,R.__bindingPointIndex),c.set(ae,de))}function Le(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),a.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),u={},ne=null,ce={},h={},d=new WeakMap,p=[],g=null,x=!1,m=null,f=null,b=null,E=null,S=null,I=null,C=null,A=new Ce(0,0,0),N=0,y=!1,M=null,P=null,W=null,H=null,K=null,Xe.set(0,0,s.canvas.width,s.canvas.height),q.set(0,0,s.canvas.width,s.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:le,disable:Se,bindFramebuffer:qe,drawBuffers:we,useProgram:rt,setBlending:w,setMaterial:Et,setFlipSided:Ke,setCullFace:nt,setLineWidth:ge,setPolygonOffset:Ge,setScissorTest:Ee,activeTexture:Ne,bindTexture:ft,unbindTexture:T,compressedTexImage2D:_,compressedTexImage3D:F,texImage2D:xe,texImage3D:$,updateUBOMapping:be,uniformBlockBinding:ie,texStorage2D:re,texStorage3D:me,texSubImage2D:X,texSubImage3D:Z,compressedTexSubImage2D:V,compressedTexSubImage3D:_e,scissor:ue,viewport:Ae,reset:Le}}function Ag(s,e,t,n,i,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new ke,u=new WeakMap;let h;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(T,_){return p?new OffscreenCanvas(T,_):us("canvas")}function x(T,_,F){let X=1;const Z=ft(T);if((Z.width>F||Z.height>F)&&(X=F/Math.max(Z.width,Z.height)),X<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const V=Math.floor(X*Z.width),_e=Math.floor(X*Z.height);h===void 0&&(h=g(V,_e));const re=_?g(V,_e):h;return re.width=V,re.height=_e,re.getContext("2d").drawImage(T,0,0,V,_e),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+V+"x"+_e+")."),re}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),T;return T}function m(T){return T.generateMipmaps}function f(T){s.generateMipmap(T)}function b(T){return T.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?s.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function E(T,_,F,X,Z=!1){if(T!==null){if(s[T]!==void 0)return s[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let V=_;if(_===s.RED&&(F===s.FLOAT&&(V=s.R32F),F===s.HALF_FLOAT&&(V=s.R16F),F===s.UNSIGNED_BYTE&&(V=s.R8)),_===s.RED_INTEGER&&(F===s.UNSIGNED_BYTE&&(V=s.R8UI),F===s.UNSIGNED_SHORT&&(V=s.R16UI),F===s.UNSIGNED_INT&&(V=s.R32UI),F===s.BYTE&&(V=s.R8I),F===s.SHORT&&(V=s.R16I),F===s.INT&&(V=s.R32I)),_===s.RG&&(F===s.FLOAT&&(V=s.RG32F),F===s.HALF_FLOAT&&(V=s.RG16F),F===s.UNSIGNED_BYTE&&(V=s.RG8)),_===s.RG_INTEGER&&(F===s.UNSIGNED_BYTE&&(V=s.RG8UI),F===s.UNSIGNED_SHORT&&(V=s.RG16UI),F===s.UNSIGNED_INT&&(V=s.RG32UI),F===s.BYTE&&(V=s.RG8I),F===s.SHORT&&(V=s.RG16I),F===s.INT&&(V=s.RG32I)),_===s.RGB_INTEGER&&(F===s.UNSIGNED_BYTE&&(V=s.RGB8UI),F===s.UNSIGNED_SHORT&&(V=s.RGB16UI),F===s.UNSIGNED_INT&&(V=s.RGB32UI),F===s.BYTE&&(V=s.RGB8I),F===s.SHORT&&(V=s.RGB16I),F===s.INT&&(V=s.RGB32I)),_===s.RGBA_INTEGER&&(F===s.UNSIGNED_BYTE&&(V=s.RGBA8UI),F===s.UNSIGNED_SHORT&&(V=s.RGBA16UI),F===s.UNSIGNED_INT&&(V=s.RGBA32UI),F===s.BYTE&&(V=s.RGBA8I),F===s.SHORT&&(V=s.RGBA16I),F===s.INT&&(V=s.RGBA32I)),_===s.RGB&&F===s.UNSIGNED_INT_5_9_9_9_REV&&(V=s.RGB9_E5),_===s.RGBA){const _e=Z?$s:Ve.getTransfer(X);F===s.FLOAT&&(V=s.RGBA32F),F===s.HALF_FLOAT&&(V=s.RGBA16F),F===s.UNSIGNED_BYTE&&(V=_e===tt?s.SRGB8_ALPHA8:s.RGBA8),F===s.UNSIGNED_SHORT_4_4_4_4&&(V=s.RGBA4),F===s.UNSIGNED_SHORT_5_5_5_1&&(V=s.RGB5_A1)}return(V===s.R16F||V===s.R32F||V===s.RG16F||V===s.RG32F||V===s.RGBA16F||V===s.RGBA32F)&&e.get("EXT_color_buffer_float"),V}function S(T,_){let F;return T?_===null||_===si||_===rs?F=s.DEPTH24_STENCIL8:_===$t?F=s.DEPTH32F_STENCIL8:_===ss&&(F=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===si||_===rs?F=s.DEPTH_COMPONENT24:_===$t?F=s.DEPTH_COMPONENT32F:_===ss&&(F=s.DEPTH_COMPONENT16),F}function I(T,_){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==Rt&&T.minFilter!==Ft?Math.log2(Math.max(_.width,_.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?_.mipmaps.length:1}function C(T){const _=T.target;_.removeEventListener("dispose",C),N(_),_.isVideoTexture&&u.delete(_)}function A(T){const _=T.target;_.removeEventListener("dispose",A),M(_)}function N(T){const _=n.get(T);if(_.__webglInit===void 0)return;const F=T.source,X=d.get(F);if(X){const Z=X[_.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&y(T),Object.keys(X).length===0&&d.delete(F)}n.remove(T)}function y(T){const _=n.get(T);s.deleteTexture(_.__webglTexture);const F=T.source,X=d.get(F);delete X[_.__cacheKey],a.memory.textures--}function M(T){const _=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(_.__webglFramebuffer[X]))for(let Z=0;Z<_.__webglFramebuffer[X].length;Z++)s.deleteFramebuffer(_.__webglFramebuffer[X][Z]);else s.deleteFramebuffer(_.__webglFramebuffer[X]);_.__webglDepthbuffer&&s.deleteRenderbuffer(_.__webglDepthbuffer[X])}else{if(Array.isArray(_.__webglFramebuffer))for(let X=0;X<_.__webglFramebuffer.length;X++)s.deleteFramebuffer(_.__webglFramebuffer[X]);else s.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&s.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&s.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let X=0;X<_.__webglColorRenderbuffer.length;X++)_.__webglColorRenderbuffer[X]&&s.deleteRenderbuffer(_.__webglColorRenderbuffer[X]);_.__webglDepthRenderbuffer&&s.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const F=T.textures;for(let X=0,Z=F.length;X<Z;X++){const V=n.get(F[X]);V.__webglTexture&&(s.deleteTexture(V.__webglTexture),a.memory.textures--),n.remove(F[X])}n.remove(T)}let P=0;function W(){P=0}function H(){const T=P;return T>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+i.maxTextures),P+=1,T}function K(T){const _=[];return _.push(T.wrapS),_.push(T.wrapT),_.push(T.wrapR||0),_.push(T.magFilter),_.push(T.minFilter),_.push(T.anisotropy),_.push(T.internalFormat),_.push(T.format),_.push(T.type),_.push(T.generateMipmaps),_.push(T.premultiplyAlpha),_.push(T.flipY),_.push(T.unpackAlignment),_.push(T.colorSpace),_.join()}function j(T,_){const F=n.get(T);if(T.isVideoTexture&&Ee(T),T.isRenderTargetTexture===!1&&T.version>0&&F.__version!==T.version){const X=T.image;if(X===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Me(F,T,_);return}}t.bindTexture(s.TEXTURE_2D,F.__webglTexture,s.TEXTURE0+_)}function G(T,_){const F=n.get(T);if(T.version>0&&F.__version!==T.version){Me(F,T,_);return}t.bindTexture(s.TEXTURE_2D_ARRAY,F.__webglTexture,s.TEXTURE0+_)}function z(T,_){const F=n.get(T);if(T.version>0&&F.__version!==T.version){Me(F,T,_);return}t.bindTexture(s.TEXTURE_3D,F.__webglTexture,s.TEXTURE0+_)}function k(T,_){const F=n.get(T);if(T.version>0&&F.__version!==T.version){le(F,T,_);return}t.bindTexture(s.TEXTURE_CUBE_MAP,F.__webglTexture,s.TEXTURE0+_)}const ne={[Pi]:s.REPEAT,[Un]:s.CLAMP_TO_EDGE,[Zs]:s.MIRRORED_REPEAT},ce={[Rt]:s.NEAREST,[zc]:s.NEAREST_MIPMAP_NEAREST,[$i]:s.NEAREST_MIPMAP_LINEAR,[Ft]:s.LINEAR,[Gs]:s.LINEAR_MIPMAP_NEAREST,[vn]:s.LINEAR_MIPMAP_LINEAR},ve={[lu]:s.NEVER,[mu]:s.ALWAYS,[uu]:s.LESS,[Kc]:s.LEQUAL,[hu]:s.EQUAL,[pu]:s.GEQUAL,[du]:s.GREATER,[fu]:s.NOTEQUAL};function Oe(T,_){if(_.type===$t&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Ft||_.magFilter===Gs||_.magFilter===$i||_.magFilter===vn||_.minFilter===Ft||_.minFilter===Gs||_.minFilter===$i||_.minFilter===vn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(T,s.TEXTURE_WRAP_S,ne[_.wrapS]),s.texParameteri(T,s.TEXTURE_WRAP_T,ne[_.wrapT]),(T===s.TEXTURE_3D||T===s.TEXTURE_2D_ARRAY)&&s.texParameteri(T,s.TEXTURE_WRAP_R,ne[_.wrapR]),s.texParameteri(T,s.TEXTURE_MAG_FILTER,ce[_.magFilter]),s.texParameteri(T,s.TEXTURE_MIN_FILTER,ce[_.minFilter]),_.compareFunction&&(s.texParameteri(T,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(T,s.TEXTURE_COMPARE_FUNC,ve[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Rt||_.minFilter!==$i&&_.minFilter!==vn||_.type===$t&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");s.texParameterf(T,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,i.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Xe(T,_){let F=!1;T.__webglInit===void 0&&(T.__webglInit=!0,_.addEventListener("dispose",C));const X=_.source;let Z=d.get(X);Z===void 0&&(Z={},d.set(X,Z));const V=K(_);if(V!==T.__cacheKey){Z[V]===void 0&&(Z[V]={texture:s.createTexture(),usedTimes:0},a.memory.textures++,F=!0),Z[V].usedTimes++;const _e=Z[T.__cacheKey];_e!==void 0&&(Z[T.__cacheKey].usedTimes--,_e.usedTimes===0&&y(_)),T.__cacheKey=V,T.__webglTexture=Z[V].texture}return F}function q(T,_,F){return Math.floor(Math.floor(T/F)/_)}function te(T,_,F,X){const V=T.updateRanges;if(V.length===0)t.texSubImage2D(s.TEXTURE_2D,0,0,0,_.width,_.height,F,X,_.data);else{V.sort(($,ue)=>$.start-ue.start);let _e=0;for(let $=1;$<V.length;$++){const ue=V[_e],Ae=V[$],be=ue.start+ue.count,ie=q(Ae.start,_.width,4),Le=q(ue.start,_.width,4);Ae.start<=be+1&&ie===Le&&q(Ae.start+Ae.count-1,_.width,4)===ie?ue.count=Math.max(ue.count,Ae.start+Ae.count-ue.start):(++_e,V[_e]=Ae)}V.length=_e+1;const re=s.getParameter(s.UNPACK_ROW_LENGTH),me=s.getParameter(s.UNPACK_SKIP_PIXELS),xe=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,_.width);for(let $=0,ue=V.length;$<ue;$++){const Ae=V[$],be=Math.floor(Ae.start/4),ie=Math.ceil(Ae.count/4),Le=be%_.width,R=Math.floor(be/_.width),ae=ie,J=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,Le),s.pixelStorei(s.UNPACK_SKIP_ROWS,R),t.texSubImage2D(s.TEXTURE_2D,0,Le,R,ae,J,F,X,_.data)}T.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,re),s.pixelStorei(s.UNPACK_SKIP_PIXELS,me),s.pixelStorei(s.UNPACK_SKIP_ROWS,xe)}}function Me(T,_,F){let X=s.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(X=s.TEXTURE_2D_ARRAY),_.isData3DTexture&&(X=s.TEXTURE_3D);const Z=Xe(T,_),V=_.source;t.bindTexture(X,T.__webglTexture,s.TEXTURE0+F);const _e=n.get(V);if(V.version!==_e.__version||Z===!0){t.activeTexture(s.TEXTURE0+F);const re=Ve.getPrimaries(Ve.workingColorSpace),me=_.colorSpace===Dn?null:Ve.getPrimaries(_.colorSpace),xe=_.colorSpace===Dn||re===me?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,_.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,_.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);let $=x(_.image,!1,i.maxTextureSize);$=Ne(_,$);const ue=r.convert(_.format,_.colorSpace),Ae=r.convert(_.type);let be=E(_.internalFormat,ue,Ae,_.colorSpace,_.isVideoTexture);Oe(X,_);let ie;const Le=_.mipmaps,R=_.isVideoTexture!==!0,ae=_e.__version===void 0||Z===!0,J=V.dataReady,de=I(_,$);if(_.isDepthTexture)be=S(_.format===os,_.type),ae&&(R?t.texStorage2D(s.TEXTURE_2D,1,be,$.width,$.height):t.texImage2D(s.TEXTURE_2D,0,be,$.width,$.height,0,ue,Ae,null));else if(_.isDataTexture)if(Le.length>0){R&&ae&&t.texStorage2D(s.TEXTURE_2D,de,be,Le[0].width,Le[0].height);for(let Q=0,Y=Le.length;Q<Y;Q++)ie=Le[Q],R?J&&t.texSubImage2D(s.TEXTURE_2D,Q,0,0,ie.width,ie.height,ue,Ae,ie.data):t.texImage2D(s.TEXTURE_2D,Q,be,ie.width,ie.height,0,ue,Ae,ie.data);_.generateMipmaps=!1}else R?(ae&&t.texStorage2D(s.TEXTURE_2D,de,be,$.width,$.height),J&&te(_,$,ue,Ae)):t.texImage2D(s.TEXTURE_2D,0,be,$.width,$.height,0,ue,Ae,$.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){R&&ae&&t.texStorage3D(s.TEXTURE_2D_ARRAY,de,be,Le[0].width,Le[0].height,$.depth);for(let Q=0,Y=Le.length;Q<Y;Q++)if(ie=Le[Q],_.format!==kt)if(ue!==null)if(R){if(J)if(_.layerUpdates.size>0){const fe=ac(ie.width,ie.height,_.format,_.type);for(const De of _.layerUpdates){const it=ie.data.subarray(De*fe/ie.data.BYTES_PER_ELEMENT,(De+1)*fe/ie.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,De,ie.width,ie.height,1,ue,it)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,0,ie.width,ie.height,$.depth,ue,ie.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,Q,be,ie.width,ie.height,$.depth,0,ie.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else R?J&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,Q,0,0,0,ie.width,ie.height,$.depth,ue,Ae,ie.data):t.texImage3D(s.TEXTURE_2D_ARRAY,Q,be,ie.width,ie.height,$.depth,0,ue,Ae,ie.data)}else{R&&ae&&t.texStorage2D(s.TEXTURE_2D,de,be,Le[0].width,Le[0].height);for(let Q=0,Y=Le.length;Q<Y;Q++)ie=Le[Q],_.format!==kt?ue!==null?R?J&&t.compressedTexSubImage2D(s.TEXTURE_2D,Q,0,0,ie.width,ie.height,ue,ie.data):t.compressedTexImage2D(s.TEXTURE_2D,Q,be,ie.width,ie.height,0,ie.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):R?J&&t.texSubImage2D(s.TEXTURE_2D,Q,0,0,ie.width,ie.height,ue,Ae,ie.data):t.texImage2D(s.TEXTURE_2D,Q,be,ie.width,ie.height,0,ue,Ae,ie.data)}else if(_.isDataArrayTexture)if(R){if(ae&&t.texStorage3D(s.TEXTURE_2D_ARRAY,de,be,$.width,$.height,$.depth),J)if(_.layerUpdates.size>0){const Q=ac($.width,$.height,_.format,_.type);for(const Y of _.layerUpdates){const fe=$.data.subarray(Y*Q/$.data.BYTES_PER_ELEMENT,(Y+1)*Q/$.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,Y,$.width,$.height,1,ue,Ae,fe)}_.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,ue,Ae,$.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,be,$.width,$.height,$.depth,0,ue,Ae,$.data);else if(_.isData3DTexture)R?(ae&&t.texStorage3D(s.TEXTURE_3D,de,be,$.width,$.height,$.depth),J&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,ue,Ae,$.data)):t.texImage3D(s.TEXTURE_3D,0,be,$.width,$.height,$.depth,0,ue,Ae,$.data);else if(_.isFramebufferTexture){if(ae)if(R)t.texStorage2D(s.TEXTURE_2D,de,be,$.width,$.height);else{let Q=$.width,Y=$.height;for(let fe=0;fe<de;fe++)t.texImage2D(s.TEXTURE_2D,fe,be,Q,Y,0,ue,Ae,null),Q>>=1,Y>>=1}}else if(Le.length>0){if(R&&ae){const Q=ft(Le[0]);t.texStorage2D(s.TEXTURE_2D,de,be,Q.width,Q.height)}for(let Q=0,Y=Le.length;Q<Y;Q++)ie=Le[Q],R?J&&t.texSubImage2D(s.TEXTURE_2D,Q,0,0,ue,Ae,ie):t.texImage2D(s.TEXTURE_2D,Q,be,ue,Ae,ie);_.generateMipmaps=!1}else if(R){if(ae){const Q=ft($);t.texStorage2D(s.TEXTURE_2D,de,be,Q.width,Q.height)}J&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,ue,Ae,$)}else t.texImage2D(s.TEXTURE_2D,0,be,ue,Ae,$);m(_)&&f(X),_e.__version=V.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function le(T,_,F){if(_.image.length!==6)return;const X=Xe(T,_),Z=_.source;t.bindTexture(s.TEXTURE_CUBE_MAP,T.__webglTexture,s.TEXTURE0+F);const V=n.get(Z);if(Z.version!==V.__version||X===!0){t.activeTexture(s.TEXTURE0+F);const _e=Ve.getPrimaries(Ve.workingColorSpace),re=_.colorSpace===Dn?null:Ve.getPrimaries(_.colorSpace),me=_.colorSpace===Dn||_e===re?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,_.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,_.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,me);const xe=_.isCompressedTexture||_.image[0].isCompressedTexture,$=_.image[0]&&_.image[0].isDataTexture,ue=[];for(let Y=0;Y<6;Y++)!xe&&!$?ue[Y]=x(_.image[Y],!0,i.maxCubemapSize):ue[Y]=$?_.image[Y].image:_.image[Y],ue[Y]=Ne(_,ue[Y]);const Ae=ue[0],be=r.convert(_.format,_.colorSpace),ie=r.convert(_.type),Le=E(_.internalFormat,be,ie,_.colorSpace),R=_.isVideoTexture!==!0,ae=V.__version===void 0||X===!0,J=Z.dataReady;let de=I(_,Ae);Oe(s.TEXTURE_CUBE_MAP,_);let Q;if(xe){R&&ae&&t.texStorage2D(s.TEXTURE_CUBE_MAP,de,Le,Ae.width,Ae.height);for(let Y=0;Y<6;Y++){Q=ue[Y].mipmaps;for(let fe=0;fe<Q.length;fe++){const De=Q[fe];_.format!==kt?be!==null?R?J&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Y,fe,0,0,De.width,De.height,be,De.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Y,fe,Le,De.width,De.height,0,De.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):R?J&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Y,fe,0,0,De.width,De.height,be,ie,De.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Y,fe,Le,De.width,De.height,0,be,ie,De.data)}}}else{if(Q=_.mipmaps,R&&ae){Q.length>0&&de++;const Y=ft(ue[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,de,Le,Y.width,Y.height)}for(let Y=0;Y<6;Y++)if($){R?J&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,0,0,ue[Y].width,ue[Y].height,be,ie,ue[Y].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,Le,ue[Y].width,ue[Y].height,0,be,ie,ue[Y].data);for(let fe=0;fe<Q.length;fe++){const it=Q[fe].image[Y].image;R?J&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Y,fe+1,0,0,it.width,it.height,be,ie,it.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Y,fe+1,Le,it.width,it.height,0,be,ie,it.data)}}else{R?J&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,0,0,be,ie,ue[Y]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,Le,be,ie,ue[Y]);for(let fe=0;fe<Q.length;fe++){const De=Q[fe];R?J&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Y,fe+1,0,0,be,ie,De.image[Y]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Y,fe+1,Le,be,ie,De.image[Y])}}}m(_)&&f(s.TEXTURE_CUBE_MAP),V.__version=Z.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function Se(T,_,F,X,Z,V){const _e=r.convert(F.format,F.colorSpace),re=r.convert(F.type),me=E(F.internalFormat,_e,re,F.colorSpace),xe=n.get(_),$=n.get(F);if($.__renderTarget=_,!xe.__hasExternalTextures){const ue=Math.max(1,_.width>>V),Ae=Math.max(1,_.height>>V);Z===s.TEXTURE_3D||Z===s.TEXTURE_2D_ARRAY?t.texImage3D(Z,V,me,ue,Ae,_.depth,0,_e,re,null):t.texImage2D(Z,V,me,ue,Ae,0,_e,re,null)}t.bindFramebuffer(s.FRAMEBUFFER,T),Ge(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,X,Z,$.__webglTexture,0,ge(_)):(Z===s.TEXTURE_2D||Z>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,X,Z,$.__webglTexture,V),t.bindFramebuffer(s.FRAMEBUFFER,null)}function qe(T,_,F){if(s.bindRenderbuffer(s.RENDERBUFFER,T),_.depthBuffer){const X=_.depthTexture,Z=X&&X.isDepthTexture?X.type:null,V=S(_.stencilBuffer,Z),_e=_.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,re=ge(_);Ge(_)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,re,V,_.width,_.height):F?s.renderbufferStorageMultisample(s.RENDERBUFFER,re,V,_.width,_.height):s.renderbufferStorage(s.RENDERBUFFER,V,_.width,_.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,_e,s.RENDERBUFFER,T)}else{const X=_.textures;for(let Z=0;Z<X.length;Z++){const V=X[Z],_e=r.convert(V.format,V.colorSpace),re=r.convert(V.type),me=E(V.internalFormat,_e,re,V.colorSpace),xe=ge(_);F&&Ge(_)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,xe,me,_.width,_.height):Ge(_)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,xe,me,_.width,_.height):s.renderbufferStorage(s.RENDERBUFFER,me,_.width,_.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function we(T,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(s.FRAMEBUFFER,T),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const X=n.get(_.depthTexture);X.__renderTarget=_,(!X.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),j(_.depthTexture,0);const Z=X.__webglTexture,V=ge(_);if(_.depthTexture.format===as)Ge(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Z,0,V):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Z,0);else if(_.depthTexture.format===os)Ge(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Z,0,V):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function rt(T){const _=n.get(T),F=T.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==T.depthTexture){const X=T.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),X){const Z=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,X.removeEventListener("dispose",Z)};X.addEventListener("dispose",Z),_.__depthDisposeCallback=Z}_.__boundDepthTexture=X}if(T.depthTexture&&!_.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");const X=T.texture.mipmaps;X&&X.length>0?we(_.__webglFramebuffer[0],T):we(_.__webglFramebuffer,T)}else if(F){_.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer[X]),_.__webglDepthbuffer[X]===void 0)_.__webglDepthbuffer[X]=s.createRenderbuffer(),qe(_.__webglDepthbuffer[X],T,!1);else{const Z=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,V=_.__webglDepthbuffer[X];s.bindRenderbuffer(s.RENDERBUFFER,V),s.framebufferRenderbuffer(s.FRAMEBUFFER,Z,s.RENDERBUFFER,V)}}else{const X=T.texture.mipmaps;if(X&&X.length>0?t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=s.createRenderbuffer(),qe(_.__webglDepthbuffer,T,!1);else{const Z=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,V=_.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,V),s.framebufferRenderbuffer(s.FRAMEBUFFER,Z,s.RENDERBUFFER,V)}}t.bindFramebuffer(s.FRAMEBUFFER,null)}function at(T,_,F){const X=n.get(T);_!==void 0&&Se(X.__webglFramebuffer,T,T.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),F!==void 0&&rt(T)}function Ye(T){const _=T.texture,F=n.get(T),X=n.get(_);T.addEventListener("dispose",A);const Z=T.textures,V=T.isWebGLCubeRenderTarget===!0,_e=Z.length>1;if(_e||(X.__webglTexture===void 0&&(X.__webglTexture=s.createTexture()),X.__version=_.version,a.memory.textures++),V){F.__webglFramebuffer=[];for(let re=0;re<6;re++)if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer[re]=[];for(let me=0;me<_.mipmaps.length;me++)F.__webglFramebuffer[re][me]=s.createFramebuffer()}else F.__webglFramebuffer[re]=s.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer=[];for(let re=0;re<_.mipmaps.length;re++)F.__webglFramebuffer[re]=s.createFramebuffer()}else F.__webglFramebuffer=s.createFramebuffer();if(_e)for(let re=0,me=Z.length;re<me;re++){const xe=n.get(Z[re]);xe.__webglTexture===void 0&&(xe.__webglTexture=s.createTexture(),a.memory.textures++)}if(T.samples>0&&Ge(T)===!1){F.__webglMultisampledFramebuffer=s.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let re=0;re<Z.length;re++){const me=Z[re];F.__webglColorRenderbuffer[re]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,F.__webglColorRenderbuffer[re]);const xe=r.convert(me.format,me.colorSpace),$=r.convert(me.type),ue=E(me.internalFormat,xe,$,me.colorSpace,T.isXRRenderTarget===!0),Ae=ge(T);s.renderbufferStorageMultisample(s.RENDERBUFFER,Ae,ue,T.width,T.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+re,s.RENDERBUFFER,F.__webglColorRenderbuffer[re])}s.bindRenderbuffer(s.RENDERBUFFER,null),T.depthBuffer&&(F.__webglDepthRenderbuffer=s.createRenderbuffer(),qe(F.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(V){t.bindTexture(s.TEXTURE_CUBE_MAP,X.__webglTexture),Oe(s.TEXTURE_CUBE_MAP,_);for(let re=0;re<6;re++)if(_.mipmaps&&_.mipmaps.length>0)for(let me=0;me<_.mipmaps.length;me++)Se(F.__webglFramebuffer[re][me],T,_,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+re,me);else Se(F.__webglFramebuffer[re],T,_,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+re,0);m(_)&&f(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(_e){for(let re=0,me=Z.length;re<me;re++){const xe=Z[re],$=n.get(xe);t.bindTexture(s.TEXTURE_2D,$.__webglTexture),Oe(s.TEXTURE_2D,xe),Se(F.__webglFramebuffer,T,xe,s.COLOR_ATTACHMENT0+re,s.TEXTURE_2D,0),m(xe)&&f(s.TEXTURE_2D)}t.unbindTexture()}else{let re=s.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(re=T.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(re,X.__webglTexture),Oe(re,_),_.mipmaps&&_.mipmaps.length>0)for(let me=0;me<_.mipmaps.length;me++)Se(F.__webglFramebuffer[me],T,_,s.COLOR_ATTACHMENT0,re,me);else Se(F.__webglFramebuffer,T,_,s.COLOR_ATTACHMENT0,re,0);m(_)&&f(re),t.unbindTexture()}T.depthBuffer&&rt(T)}function w(T){const _=T.textures;for(let F=0,X=_.length;F<X;F++){const Z=_[F];if(m(Z)){const V=b(T),_e=n.get(Z).__webglTexture;t.bindTexture(V,_e),f(V),t.unbindTexture()}}}const Et=[],Ke=[];function nt(T){if(T.samples>0){if(Ge(T)===!1){const _=T.textures,F=T.width,X=T.height;let Z=s.COLOR_BUFFER_BIT;const V=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,_e=n.get(T),re=_.length>1;if(re)for(let xe=0;xe<_.length;xe++)t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+xe,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+xe,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,_e.__webglMultisampledFramebuffer);const me=T.texture.mipmaps;me&&me.length>0?t.bindFramebuffer(s.DRAW_FRAMEBUFFER,_e.__webglFramebuffer[0]):t.bindFramebuffer(s.DRAW_FRAMEBUFFER,_e.__webglFramebuffer);for(let xe=0;xe<_.length;xe++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(Z|=s.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(Z|=s.STENCIL_BUFFER_BIT)),re){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,_e.__webglColorRenderbuffer[xe]);const $=n.get(_[xe]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,$,0)}s.blitFramebuffer(0,0,F,X,0,0,F,X,Z,s.NEAREST),c===!0&&(Et.length=0,Ke.length=0,Et.push(s.COLOR_ATTACHMENT0+xe),T.depthBuffer&&T.resolveDepthBuffer===!1&&(Et.push(V),Ke.push(V),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Ke)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Et))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),re)for(let xe=0;xe<_.length;xe++){t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+xe,s.RENDERBUFFER,_e.__webglColorRenderbuffer[xe]);const $=n.get(_[xe]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+xe,s.TEXTURE_2D,$,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,_e.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&c){const _=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[_])}}}function ge(T){return Math.min(i.maxSamples,T.samples)}function Ge(T){const _=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Ee(T){const _=a.render.frame;u.get(T)!==_&&(u.set(T,_),T.update())}function Ne(T,_){const F=T.colorSpace,X=T.format,Z=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||F!==Pt&&F!==Dn&&(Ve.getTransfer(F)===tt?(X!==kt||Z!==rn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),_}function ft(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(l.width=T.naturalWidth||T.width,l.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(l.width=T.displayWidth,l.height=T.displayHeight):(l.width=T.width,l.height=T.height),l}this.allocateTextureUnit=H,this.resetTextureUnits=W,this.setTexture2D=j,this.setTexture2DArray=G,this.setTexture3D=z,this.setTextureCube=k,this.rebindTextures=at,this.setupRenderTarget=Ye,this.updateRenderTargetMipmap=w,this.updateMultisampleRenderTarget=nt,this.setupDepthRenderbuffer=rt,this.setupFrameBufferTexture=Se,this.useMultisampledRTT=Ge}function wg(s,e){function t(n,i=Dn){let r;const a=Ve.getTransfer(i);if(n===rn)return s.UNSIGNED_BYTE;if(n===ka)return s.UNSIGNED_SHORT_4_4_4_4;if(n===Va)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Vc)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Hc)return s.BYTE;if(n===kc)return s.SHORT;if(n===ss)return s.UNSIGNED_SHORT;if(n===Ha)return s.INT;if(n===si)return s.UNSIGNED_INT;if(n===$t)return s.FLOAT;if(n===hs)return s.HALF_FLOAT;if(n===Gc)return s.ALPHA;if(n===Wc)return s.RGB;if(n===kt)return s.RGBA;if(n===as)return s.DEPTH_COMPONENT;if(n===os)return s.DEPTH_STENCIL;if(n===Ga)return s.RED;if(n===Wa)return s.RED_INTEGER;if(n===Xc)return s.RG;if(n===Xa)return s.RG_INTEGER;if(n===qa)return s.RGBA_INTEGER;if(n===Ws||n===Xs||n===qs||n===Ys)if(a===tt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Ws)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Xs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===qs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ys)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Ws)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Xs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===qs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ys)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ra||n===aa||n===oa||n===ca)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ra)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===aa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===oa)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ca)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===la||n===ua||n===ha)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===la||n===ua)return a===tt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ha)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===da||n===fa||n===pa||n===ma||n===ga||n===_a||n===xa||n===va||n===Ma||n===Sa||n===ya||n===Ea||n===Ta||n===ba)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===da)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===fa)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===pa)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ma)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ga)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===_a)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===xa)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===va)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ma)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Sa)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ya)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ea)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ta)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ba)return a===tt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ks||n===Aa||n===wa)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ks)return a===tt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Aa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===wa)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===qc||n===Ra||n===Ca||n===Pa)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Ks)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ra)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ca)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Pa)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===rs?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}const Rg=`
void main() {
